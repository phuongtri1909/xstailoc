                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST"
                    ...
                    <div class="form-group">
                       ...
                       <textarea id="des" rows="5" name="des" placeholder="Mô tả"
                                 class="form-control">{!! old('des') !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<div class="col-xs-10">--}}
                            {{--<div class="input input-icon-left input-file">--}}
                                {{--{{ Form::text('img','',array('placeholder'=>'Hình ảnh','class'=>'col-xs-6','id'=>'img'))}}--}}
                                {{--<a href="/filemanager/dialog.php?type=2&field_id=img" class="btn btn-success btn-xs iframe-btn" style="margin-left: 10px" type="button">Chọn--}}
                                    {{--ảnh</a>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
