    ...
    @if($xs->date==date('Y-m-d',time()))
        <div class="box" id='kqngay_{{getNgayID($xs->date)}}'>
            ...
            <div id="load_kq_tinh_{{$d}}">
                    ...
                    <table class="kqmb extendable kqtinh">
                        ...
                        <tr class="g8">
                            ...
                            <td class="v-giai number"><span data-nc="2" class="v-g8 "
                                                            id="{{strtoupper($xs->province->short_name)}}_prize_8_item_0">@if(!empty($g8[0])){{$g8[0]}}@endif</span>
                            </td>
                        ...
                        <tr class="bg_ef">
                            ...
                            <td class="v-giai number"><span data-nc="3" class="v-g7 "
                                                            id="{{strtoupper($xs->province->short_name)}}_prize_7_item_0">@if(!empty($g7[0])){{$g7[0]}}@endif</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="v-giai number">
                                <span data-nc="4" class="v-g6-0 "
                                      id="{{strtoupper($xs->province->short_name)}}_prize_6_item_0">@if(!empty($g6[0])){{$g6[0]}}@endif</span><span
                                        data-nc="4" class="v-g6-1 "
                                        id="{{strtoupper($xs->province->short_name)}}_prize_6_item_1">@if(!empty($g6[1])){{$g6[1]}}@endif</span><span
                                        data-nc="4" class="v-g6-2 "
                                        id="{{strtoupper($xs->province->short_name)}}_prize_6_item_2">@if(!empty($g6[2])){{$g6[2]}}@endif</span>
                            </td>
                        </tr>
                        <tr class="bg_ef">
                            ...
                            <td class="v-giai number">
                                <span data-nc="4" class="v-g5 "
                                      id="{{strtoupper($xs->province->short_name)}}_prize_5_item_0">@if(!empty($g5[0])){{$g5[0]}}@endif</span>
                            </td>
                        </tr>
                        ...
                        <tr class="g4">
                            ...
                            <td class="v-giai number">
                                <span data-nc="5" class="v-g4-0 "
                                      id="{{strtoupper($xs->province->short_name)}}_prize_4_item_0">@if(!empty($g4[0])){{$g4[0]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-1 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_1">@if(!empty($g4[1])){{$g4[1]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-2 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_2">@if(!empty($g4[2])){{$g4[2]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-3 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_3">@if(!empty($g4[3])){{$g4[3]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-4 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_4">@if(!empty($g4[4])){{$g4[4]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-5 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_5">@if(!empty($g4[5])){{$g4[5]}}@endif</span><!--
                                    --><span data-nc="5" class="v-g4-6 "
                                             id="{{strtoupper($xs->province->short_name)}}_prize_4_item_6">@if(!empty($g4[6])){{$g4[6]}}@endif</span>
                            </td>
                        </tr>
                        ...
                        <tr class="bg_ef">
                            ...
                            <td class="v-giai number">
                                <span data-nc="5" class="v-g3-0 "
                                      id="{{strtoupper($xs->province->short_name)}}_prize_3_item_0">@if(!empty($g3[0])){{$g3[0]}}@endif</span><!--
                                        --><span data-nc="5" class="v-g3-1 "
                                                 id="{{strtoupper($xs->province->short_name)}}_prize_3_item_1">@if(!empty($g3[1])){{$g3[1]}}@endif</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="v-giai number">
                                <span data-nc="5" class="v-g2 "
                                      id="{{strtoupper($xs->province->short_name)}}_prize_2_item_0">@if(!empty($g2[0])){{$g2[0]}}@endif</span>
                            </td>
                        </tr>
                        <tr class="bg_ef">
                            <td class="txt-giai">G.1</td>
                            <td class="v-giai number"><span data-nc="5" class="v-g1 "
                                                            id="{{strtoupper($xs->province->short_name)}}_prize_1_item_0">@if(!empty($g1)){{$g1}}@endif</span>
                            </td>
                        </tr>
                        <tr class="gdb db">
                            <td class="txt-giai">ĐB</td>
                            <td class="v-giai number"><span data-nc="6" class="v-gdb "
                                                            id="{{strtoupper($xs->province->short_name)}}_prize_db_item_0">@if(!empty($gdb)){{$gdb}}@endif</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div data-id="dd" class="col-firstlast" id="livebangkqloto_{{strtoupper($xs->province->short_name)}}">
                    <table class="firstlast-mb fl">
                        ...
                        <tr>
                            <td class="clred">0</td>
                            <td class="v-loto-dau-0" id="loto_{{strtoupper($xs->province->short_name)}}_0">{!! $xsDau[0] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">1</td>
                            <td class="v-loto-dau-1" id="loto_{{strtoupper($xs->province->short_name)}}_1">{!! $xsDau[1] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">2</td>
                            <td class="v-loto-dau-2" id="loto_{{strtoupper($xs->province->short_name)}}_2">{!! $xsDau[2] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">3</td>
                            <td class="v-loto-dau-3" id="loto_{{strtoupper($xs->province->short_name)}}_3">{!! $xsDau[3] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">4</td>
                            <td class="v-loto-dau-4" id="loto_{{strtoupper($xs->province->short_name)}}_4">{!! $xsDau[4] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">5</td>
                            <td class="v-loto-dau-5" id="loto_{{strtoupper($xs->province->short_name)}}_5">{!! $xsDau[5] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">6</td>
                            <td class="v-loto-dau-6" id="loto_{{strtoupper($xs->province->short_name)}}_6">{!! $xsDau[6] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">7</td>
                            <td class="v-loto-dau-7" id="loto_{{strtoupper($xs->province->short_name)}}_7">{!! $xsDau[7] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">8</td>
                            <td class="v-loto-dau-8" id="loto_{{strtoupper($xs->province->short_name)}}_8">{!! $xsDau[8] !!}</td>
                        </tr>
                        <tr>
                            <td class="clred">9</td>
                            <td class="v-loto-dau-9" id="loto_{{strtoupper($xs->province->short_name)}}_9">{!! $xsDau[9] !!}</td>
                        </tr>
                        </tbody>
                    </table>
                    <table class="firstlast-mb fr">
                        ...
                        <tr>
                            <td class="v-loto-duoi-0" id="loto_{{strtoupper($xs->province->short_name)}}_d0">{!! $xsDuoi[0] !!}</td>
                            <td class="clred">0</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-1" id="loto_{{strtoupper($xs->province->short_name)}}_d1">{!! $xsDuoi[1] !!}</td>
                            <td class="clred">1</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-2" id="loto_{{strtoupper($xs->province->short_name)}}_d2">{!! $xsDuoi[2] !!}</td>
                            <td class="clred">2</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-3" id="loto_{{strtoupper($xs->province->short_name)}}_d3">{!! $xsDuoi[3] !!}</td>
                            <td class="clred">3</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-4" id="loto_{{strtoupper($xs->province->short_name)}}_d4">{!! $xsDuoi[4] !!}</td>
                            <td class="clred">4</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-5" id="loto_{{strtoupper($xs->province->short_name)}}_d5">{!! $xsDuoi[5] !!}</td>
                            <td class="clred">5</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-6" id="loto_{{strtoupper($xs->province->short_name)}}_d6">{!! $xsDuoi[6] !!}</td>
                            <td class="clred">6</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-7" id="loto_{{strtoupper($xs->province->short_name)}}_d7">{!! $xsDuoi[7] !!}</td>
                            <td class="clred">7</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-8" id="loto_{{strtoupper($xs->province->short_name)}}_d8">{!! $xsDuoi[8] !!}</td>
                            <td class="clred">8</td>
                        </tr>
                        <tr>
                            <td class="v-loto-duoi-9" id="loto_{{strtoupper($xs->province->short_name)}}_d9">{!! $xsDuoi[9] !!}</td>
                            <td class="clred">9</td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="see-more">
                ...
                <ul class="list-html-link two-column">
                    <li>Xem thêm <a href="{{route('tk.lo-gan',$xs->province->short_name)}}" title="Thống kê lô gan {{$xs->province->name}}">thống kê lô gan {{$xs->province->name}}</a></li>
            ...
            <div id="load_kq_tinh_{{$d}}">
                ...
                @if($d==1)
                    <div class="see-more">
                        ...
                        <ul class="list-html-link two-column">
                            <li>Xem thêm <a href="{{route('tk.lo-gan',$xs->province->short_name)}}" title="Thống kê lô gan {{$xs->province->name}}">thống kê lô gan {{$xs->province->name}}</a></li>
                            <li>Mời bạn <a href="{{route('quay_thu.tinh',$xs->province->short_name)}}"
                                           title="quay thử {{$xs->province->name}}">quay thử {{$xs->province->name}}</a> hôm nay để lấy hên
                            </li>
                            <li>Xem thêm <a href="{{route('xsmb')}}"
                                            title="Kết Quả XSMB">kết quả XSMB</a></li>
                            <li>Xem bảng kết quả <a
                ...
                @elseif($d==2)
                    <div class="see-more">
                        ...
                        <ul class="list-html-link two-column">
                            ...
                            <li>Xem thêm <a href="{{route('vietlott')}}" title="kết quả xổ số Vietlott">kết quả xổ số Vietlott</a></li>
                            <li>Xem thêm <a href="{{route('mega645')}}" title="kết quả xổ số Mega 6/45">kết quả xổ số Mega 6/45</a></li>
                        </ul>
                    </div>
                @endif
                <div class="clearfix"></div>
