...
@section('content')
        ...
        <div class="page-header">
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item active">Danh sách liên kết footer</span>
                </nav>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <h2>Danh sách liên kết footer</h2>
                @include('admin.includes.messages')
                <div class="form-group text-right">
                    <button class="btn btn-success m-r-5 btn-sm add-link">Thêm liên kết footer</button>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addLinkForm" action="{{ route('link-footer.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
    ...
    <script type="text/javascript">
        ...
        $('.delete').on('click', function(e) {
            ...
            var url = '/admincp/link-footer/' + id;
