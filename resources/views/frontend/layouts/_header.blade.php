...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=GTM-N9554PZ4"></script>
        <!-- Google Tag Manager -->
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-N9554PZ4');</script>
    ...
    <script type="application/ld+json">
    {
      ...
      "@id": "https://xstailoc.com/",
      "logo": "https://xstailoc.com/frontend/images/xo-so-tai-loc.png",
      "image": "https://xstailoc.com/frontend/images/xo-so-tai-loc.png",
