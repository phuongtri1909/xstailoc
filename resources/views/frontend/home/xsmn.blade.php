...
<div class="box border-red" id='mn_kqngay_{{date('dmY',time())}}'>
    <div class="tit-mien clearfix"><h2>Kết quả xổ số miền Nam {{getNgay($xsmnTinh->date)}}</h2>
            ...
            <table class="{{$table_class}} colgiai extendable">
                ...
                <tr class="gr-yellow">
                    ...
                    @foreach ($xsmns as $xsmn)
                        <th data-pid="{{$xsmn->id}}"><a href="{{route('xstinh.tinh',$xsmn->province->slug)}}"
            ...
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_0"
                        class="v-loto-dau-0 text-left">{!! $xsmnDau[$xsmn->province->short_name][0] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_1"
                        class="v-loto-dau-1 text-left">{!! $xsmnDau[$xsmn->province->short_name][1] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_2"
                        class="v-loto-dau-2 text-left">{!! $xsmnDau[$xsmn->province->short_name][2] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_3"
                        class="v-loto-dau-3 text-left">{!! $xsmnDau[$xsmn->province->short_name][3] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_4"
                        class="v-loto-dau-4 text-left">{!! $xsmnDau[$xsmn->province->short_name][4] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_5"
                        class="v-loto-dau-5 text-left">{!! $xsmnDau[$xsmn->province->short_name][5] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_6"
                        class="v-loto-dau-6 text-left">{!! $xsmnDau[$xsmn->province->short_name][6] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_7"
                        class="v-loto-dau-7 text-left">{!! $xsmnDau[$xsmn->province->short_name][7] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_8"
                        class="v-loto-dau-8 text-left">{!! $xsmnDau[$xsmn->province->short_name][8] !!}</td>
                @endforeach
            </tr>
            <tr>
                ...
                @foreach ($xsmns as $xsmn)
                    <td id="mnloto_{{strtoupper($xsmn->province->short_name)}}_9"
                        class="v-loto-dau-9 text-left">{!! $xsmnDau[$xsmn->province->short_name][9] !!}</td>
                @endforeach
            </tr>
            </tbody>
        </table>
...
<div class="box-option p-10px m-y-20px">
    <div class="see-more">
        ...
        <ul class="list-html-link two-column">
            <li>Xem ngay <a href="{{route('dudoan.xsmn')}}"
                           title="Dự đoán XSMN">Dự đoán XSMN</a> chính xác nhất hôm nay
            </li>
            <li>Trải nghiệm <a href="{{route('quay_thu.mn')}}"
