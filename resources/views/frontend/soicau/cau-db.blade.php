...
@section('title','Soi cau giải đặc biệt miền Bắc - Soi cau XSMB - Soi cau MB')
@section('decription','Soi cau giải đặc biệt miền Bắc ✅ - Soi cau XSMB - Soi cau MB hàng ngày cực chuẩn, phân tích và thống kê các cặp số có khả năng về tính  theo CAU Mien Bac, CAU MB, SOI CAU MB.')
@section('keyword','loto mb, Soi cau XSMB,Soi cau giải đặc biệt, soi cau lo loto, soi cau xsmb, cau loto xsmb, soi cau mb, cau xsmb, soi cau lo de mien bac, soi cau mien bac hom nay, loto lo, soi cau xsmb hom nay, cau lo loto, soi cau lo de mien bac hom nay, soi cau mien bac chinh xac nhat, lo loto, du doan xsmb chinh xac nhat, soi cau lo de chuan, soi cau lo de mb, soi cau mb hom nay, du doan ket qua xsmb toi nay, soi cau mb chinh xac, soi cau lo chinh xac nhat mien bac, Soi cau miền bắc, soi cau du doan ket qua xo so mien bac, du doan soi cau mien bac, soi cau du doan xsmb')
@section('h1','Soi cau giải đặc biệt miền Bắc - Soi cau XSMB - Soi cau MB')
        ...
        <div class="main">
            <div class="breadcrumb">
                <ol itemscope="" itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a
                                itemprop="item" href="{{url()->current()}}" title="Soi cau giải đặc biệt miền Bắc"
                                class="last"><span itemprop="name">Soi cau giải đặc biệt miền Bắc</span>
...
@section('content')
    ...
    <div class="col-l">
        <div class="box">
            ...
            <h2 class="tit-mien">
                <strong>Cầu giải đặc biệt miền Bắc - Cầu XSMB chuẩn xác nhất</strong>
            </h2>
                ...
                <div class="form-group field-statisticform-provinceid">
                    ...
                    <select name="province" id="province" class="form-control">
                        ...
                        @foreach($provinces as $pro)
                            <option
                                    value="{{route('sctn.cau-db',$pro->short_name)}}">{{$pro->name}}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class=" box box-html" style="height: auto !important;">
            ...
            <p><strong><a href="#" title="Soi cầu giải đặc biệt miền bắc"><span
                                style="color:#0000FF">Soi cầu giải đặc biệt miền bắc</span></a></strong>&nbsp;thống kê
            ...
            <h2><strong>Hướng dẫn cách bắt cầu đặc biệt <a href="{{route('xsmb')}}" title="XSMB"><span
                                style="color:#0000FF">XSMB</span></a> hôm nay theo bảng:</strong></h2>
            ...
            <p style="text-align:center"><strong><a href="{{route('scmb.cau-bach-thu')}}"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('body').on('click', '.btn-outline-primary', function () {
                ...
                var url_type = '{{route('scmb.cau-db-ajax')}}';
                $.post(url_type, {
                    _token: CSRF_TOKEN,
                    date: date,
                    count: count
