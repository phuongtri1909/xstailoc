...
class GetXsmtFile extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'GetXsmtFile:everyMinute';
    ...
    {
        Log::info('File KQMT KQVS Start:' . date('Ymd H:i:s'));
        set_time_limit(0);
        $this->getKqXsmtKQVS();
        sleep(6);
        $this->getKqXsmtKQVS();
        ...
        sleep(6);
        $this->getKqXsmtKQVS();
        Log::info('File KQMT KQVS End:' . date('Ymd H:i:s'));
    }
...
//            $xsDau = getDauLive($xsLoto);
        ...
        Storage::put('xsmt.txt',json_encode($kqxs)); 
    ...
    public function fire()
    {
        ...
        Bus::dispatchFromArray('App\Console\Commands\GetXsmtFile', []);
    }
}
